...
helm -n rabbitmq install rabbitmq \
     --set rabbitmq.username='rabbitmq',rabbitmq.password='password',nameOverride='rabbitmq',persistence.storageClass='rabbitmq-storage-class',service.type='LoadBalancer',service.loadBalancerIP='192.168.6.22' \
     bitnami/rabbitmq
