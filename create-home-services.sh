...
helm -n rabbitmq install rabbitmq \
     --set rabbitmq.username=rabbitmq,rabbitmq.password=password,nameOverride=rabbitmq,persistence.storageClass=rabbitmq-storage-class,rabbitmq.clustering.k8s_domain=thesteamedcrab.com,service.type=LoadBalancer,service.loadBalancerIP=192.168.22 \
     bitnami/rabbitmq
